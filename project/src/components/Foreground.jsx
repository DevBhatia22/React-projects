...
function Foreground() {
    ...
    <>
        <div ref={boundry} className='fixed w-full h-screen p-4'>
            ...
            <div ref={adder} className='bottom-0 left-0 absolute w-full h-20 bg-[#00ADB5] flex items-center justify-around p-4 left- hidden'>
                ...
                <input value={discription} className='p-1 h-2/3 border-none outline-none bg-[#EEEEEE] leading-tight -tracking-tighter text-[#00ADB5] selection:text-[#FFC470] rounded-sm w-[40rem]' placeholder='Discription' onChange={(e)=>{
